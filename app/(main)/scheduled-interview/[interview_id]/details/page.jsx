...
function InterviewDetail() {
  ...
  return (
    <div className='mt-5'>
        ...
        {interviewDetail && <InterviewDetailContainer  interviewDetail={interviewDetail}/>}
        {interviewDetail && <CandidateList candidateList={interviewDetail?.['interview-feedback']}/>}
    </div>
  )
}
