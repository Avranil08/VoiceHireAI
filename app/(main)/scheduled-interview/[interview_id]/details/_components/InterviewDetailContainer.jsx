import { Calendar, Clock, List, MessageCircleQuestionMarkIcon, Timer } from 'lucide-react'
    ...
    <div className='p-5 bg-white rounded-lg mt-5'>
        ...
        <div className='mt-4 flex items-center justify-between lg:pr-52'>
           ...
           {interviewDetail?.type&& <div>
                ...
                <h2 className='flex text-sm font-bold items-center gap-2'><List className='h-4 w-4'/>{interviewDetail?.type && JSON.parse(interviewDetail.type).join(', ')}</h2>
            </div>}
        </div>
        <div className='mt-5'>
