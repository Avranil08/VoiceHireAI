...
function CandidateFeedbackDialog({candidate}) {
    ...
    const overallRating = (feedback?.rating?.technicalSkills+feedback?.rating?.communication+feedback?.rating?.problemSolving+feedback?.rating?.experience)/4;
  return (
    <Dialog>
        ...
        <div className='mt-5'>
          ...
          <div className='flex items-center gap-5'>
            ...
            <div className='flex gap-3 items-center'>
                <h2 className='text-primary text-2xl font-bold'>{overallRating}/10</h2>
            ...
            <div className='p-5 rounded-md bg-blue-200 mt-4'>
                <div>
                <h2 className='font-bold'>Recommendation Message:</h2>
