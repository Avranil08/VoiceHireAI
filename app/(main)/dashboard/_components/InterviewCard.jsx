...
function InterviewCard({interview,viewDetail=false}) {
    ...
    const onSend=()=>{
        window.location.href="mailto:GiveName@gmail.com?subject=AiCruiter Interview Link & body=Interview link:"+url
    }
  return (
    <div className='p-5 bg-white rounded-lg border'>
        ...
        {!viewDetail?<div className='flex justify-between gap-3 w-full mt-5'>
